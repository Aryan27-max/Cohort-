...
# 5. touch - to make a file inisde a diretory 

(eg. touch index.txt wil make a file inside a diretory)

---

# 6. cat - prints the content of a file 

(example. cat index.txt will  display the ocntent of index.txt)
...
# 8. mv (move) - moves files from one place to another  

{eg.  mv a.txt new-folder (moves a.txt to new folder) }

---

# 9. cp (copy) - copies files from one position to another 

{eg. cp a.txt new-folder  (copies a.txt to new-follder) }
...
## 2. npm (node package manager) - helps u intall js libraries 

(cmd -> npm install (name of library))
